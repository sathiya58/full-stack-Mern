...
const Appointment = () => {
  ...
  // Define fetchDocInfo inside useEffect
  useEffect(() => {
    const fetchDocInfo = () => {
    ...
    fetchDocInfo();
  }, [doctors, docId]); // Dependency array includes doctors and docId

  // Define getAvailableSlots inside useEffect
  useEffect(() => {
    if (!docInfo) return;
    ...
    getAvailableSlots();
  }, [docInfo]); // Dependency array includes docInfo
